...
ESTHESIS_EDGE_MODULES_ENEDIS_SELF_REGISTRATION_STATE_CHECKING="false" \
...
- **Test administration API authentication**
  ...
  ```curl -H "X-ESTHESIS-EDGE-ADMIN-SECRET:e35b9b5d-8831-4466-ac50-419b2a89c8b6" localhost:10080/admin/auth```
