...
| **ESTHESIS_EDGE_CORE_MQTT_CERT**<br/>--set esthesis.edge.core.mqtt.broker.cert                | esthesis CORE MQTT Broker certificate in Base64 format. Needed when connecting to MQTT via ssl://.                                                      |